...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    $urlRouterProvider.otherwise("/landing/welcome");
    //
    // Set up the states
    $stateProvider.state('app', {
        ...
        resolve: loadSequence('deviceCtrl'),
        title: 'Devices',
        ncyBreadcrumb: {
        ...
        url: "/dashboard",
        templateUrl: "assets/views/mydevices.html",
        resolve: loadSequence('mydevicesCtrl'),
        title: 'My Devices',
        ncyBreadcrumb: {
            label: 'My Devices'
        }
	...
	.state('login', {
        ...
        resolve: loadSequence('signInController'),
	}).state('login.forgot', {
	    url: '/forgot',
	    templateUrl: "assets/views/login_forgot.html",
        resolve: loadSequence('forgotPassController')
	}).state('login.registration', {
	    url: '/registration',
	    templateUrl: "assets/views/login_registration.html",
        resolve: loadSequence('registerController')
	}).state('login.lockscreen', {
	    url: '/lock',
	    templateUrl: "assets/views/login_lock_screen.html",
        resolve: loadSequence('lockScreenController')
	})
