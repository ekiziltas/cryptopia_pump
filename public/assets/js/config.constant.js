...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'signInController' :  'assets/js/controllers/signInController.js',
        'forgotPassController' :  'assets/js/controllers/forgotPassController.js',
        'registerController' :  'assets/js/controllers/registerController.js',
        'lockScreenController' :  'assets/js/controllers/lockScreenController.js',
        'deviceCtrl' :  'assets/js/controllers/deviceCtrl.js',
        'mydevicesCtrl' :  'assets/js/controllers/mydevicesCtrl.js'
    },
    //*** angularJS Modules
    modules: [{
        name: 'toaster',
